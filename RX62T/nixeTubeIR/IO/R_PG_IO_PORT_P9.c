...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Set_P93(void)
*
* Function Name: R_PG_IO_PORT_Set_P93
*
* Description  : Set up the I/O port pin
*
* Arguments    : None
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_IO_PORT_Set_P93(void)
{
	return R_IO_PORT_Set(
		PDL_IO_PORT_9_3,
		PDL_IO_PORT_OUTPUT | PDL_IO_PORT_INPUT_BUFFER_OFF
...
* Include      : 
*
* Declaration  : bool R_PG_IO_PORT_Write_P93(uint8_t data)
*
* Function Name: R_PG_IO_PORT_Write_P93
*
* Description  : Write 1-bit data to the I/O port data register
*
* Arguments    : uint8_t data : Value to be written.
...
* Details      : Please refer to the Reference Manual.
******************************************************************************/
bool R_PG_IO_PORT_Write_P93(uint8_t data)
{
	return R_IO_PORT_Write(
		PDL_IO_PORT_9_3,
		data
